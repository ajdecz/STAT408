...
-   Interpret the parameter estimate associated with low temperature in the context of the problem.
    ...
    -   \- 0.08046, as the low daily temperature increases by one degree Fahrenheit, the average number of bikers on the Brooklyn bridge decreases by a factor of exp(-0.008046) = 0.9920, holding all other variables constant.
